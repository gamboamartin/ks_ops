...
use gamboamartin\ks_ops\controllers\controlador_ks_cliente;
...
class controlador_ks_clienteTest extends test {
    ...
    public function test_init_configuraciones(): void
    {
        ...
        $_GET['session_id'] = '1';
        $_GET['registro_id'] = '1';
        $ctl = new controlador_ks_cliente(link: $this->link, paths_conf: $this->paths_conf);
